...
There are a number of terms used to describe relationships
 ...
 - **Principal entity:** This is the entity that contains the primary key property(s). Sometimes referred to as the 'parent' of the relationship.
...
.. literalinclude:: configuring/sample/EFModeling.Conventions/Samples/RelationshipFull.cs
        :language: c#
        :lines: 12-28
        :linenos:
...
While it is recommended to have a foreign key property defined in the dependent entity class, it is not required. If no foreign key property is found, a shadow foreign key property will be introduced with the name ``<principal type name><principal key property name>`` (see :doc:`shadow-properties` for more information).

.. literalinclude:: configuring/sample/EFModeling.Conventions/Samples/RelationshipNoForeignKey.cs
        :language: c#
        :lines: 12-27
...
.. literalinclude:: configuring/sample/EFModeling.Conventions/Samples/RelationshipOneNavigation.cs
        :language: c#
        :lines: 12-25
        :emphasize-lines: 6
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.DataAnnotations/Samples/RelationshipForeignKey.cs
        :language: c#
        :lines: 13-31
        :emphasize-lines: 17
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.DataAnnotations/Samples/RelationshipInverseProperty.cs
        :language: c#
        :lines: 13-37
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipNoForeignKey.cs
        :language: c#
        :lines: 6-34
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipOneNavigation.cs
        :language: c#
        :lines: 6-32
        :emphasize-lines: 10
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipForeignKey.cs
        :language: c#
        :lines: 6-36
        :emphasize-lines: 11
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipCompositeForeignKey.cs
        :language: c#
        :lines: 7-42
        :emphasize-lines: 13
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipPrincipalKey.cs
        :language: c#
        :lines: 7-39
        :emphasize-lines: 11
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipCompositePrincipalKey.cs
        :language: c#
        :lines: 7-41
        :emphasize-lines: 11
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipRequired.cs
        :language: c#
        :lines: 6-35
        :emphasize-lines: 11
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Conventions/Samples/RelationshipOneToOne.cs
        :language: c#
        :lines: 12-28
        :emphasize-lines: 6,15-16
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipOneToOne.cs
        :language: c#
        :lines: 6-36
        :emphasize-lines: 11
        :linenos:
...
.. literalinclude:: configuring/sample/EFModeling.Configuring.FluentAPI/Samples/RelationshipManyToMany.cs
        :language: c#
        :lines: 6-51
